...
Live Security Feed
    ...
    The security feed displays the live webcam footage with a bounding box around detected motion. [TODO]
    ...
    BLE/BLUETOOTH SCAN -- PING / LATENCY SCAN [TODO\
